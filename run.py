...
def main(args):
    ChRun(ChConfig(batch_size=args['batch_size'],learning_rate=args['lr'],seed=args['seed'],
              ...
              num_layers_gru=args['num_layers_gru'],epochs=args['epochs'], use_regularization=(args['use_regularization'])))
...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument('--hidden_size_gru', type=int, default=256, help='hidden size for GRU')
